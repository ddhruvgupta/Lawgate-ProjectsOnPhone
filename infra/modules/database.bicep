...
// NOTE: If delegatedSubnetResourceId is set, privateDnsZoneArmResourceId must also be provided.
// ARM will reject the deployment if the DNS zone is missing, so this is enforced at runtime.
