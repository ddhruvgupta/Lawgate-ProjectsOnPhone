...
try {
    ...
    Write-Host "Token (first 50 chars): $($registerResponse.data.token.Substring(0, 50))..." -ForegroundColor Gray
    Write-Host ""
...
try {
    ...
    Write-Host "Token (first 50 chars): $($loginResponse.data.token.Substring(0, 50))..." -ForegroundColor Gray
    Write-Host ""
...
try {
    ...
    Write-Host "[PASS] Got user info successfully!" -ForegroundColor Green
    ...
    Write-Host "[FAIL] Failed to get user info: $($_.Exception.Message)" -ForegroundColor Red
    Write-Host ""
}
...
try {
    ...
    Write-Host "[PASS] Company found in database!" -ForegroundColor Green
    ...
    Write-Host "[FAIL] Database check failed: $($_.Exception.Message)" -ForegroundColor Red
    Write-Host ""
}
